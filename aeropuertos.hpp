...
const unsigned MAX_AEROPUERTOS = 1000;
...
public:
	...
	// Operador de comparación de igualdad de Aeropuertos
	...
	// Operador de acceso por índice de Aeropuertos
	Aeropuerto operator[](unsigned i) const {
		return aeropuertos[i];
	}
private:

	std::array<Aeropuerto, MAX_AEROPUERTOS> aeropuertos;
